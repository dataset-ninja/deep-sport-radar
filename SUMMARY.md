**DeepSportRadar Instance Segmentation Challenge v.2 Dataset** is a dataset for instance segmentation, semantic segmentation, and object detection tasks. It is used in the sports industry. 
